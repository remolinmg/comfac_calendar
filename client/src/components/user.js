...
const User = () => {
  ...
  return (
    <div className="usermain p-0 max-vh-100 max-vw-100">
      <NavBar />
      <div className="max-vh-100 max-vw-100">
        <div className="row p-0 m-0">
          ...
          <div className="usertablehead col-10 vh-100">
            <div className="Tablelistuser"> List of Users</div>
            <div className="tabletopuser d-flex justify-content-between mb-1">
              ...
              <button
                type="button"
                className="btnuseradd btn btn-success"
                onClick={openModal}
              >
                Add
              </button>
